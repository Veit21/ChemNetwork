...
def test_draw_x0_and_x1_data(batch_size: int) -> None:
    ...
    """
    data_generator  = PointCloudGenerator(num_samples=batch_size)
    x0_batch        = data_generator.draw_x0()
    x1_batch        = data_generator.draw_x1()
...
def test_draw_x0_and_x1_dtype_matches_model_dtype():
    ...
    """
    data_generator  = PointCloudGenerator(num_samples=4)
    x0_batch        = data_generator.draw_x0()
    x1_batch        = data_generator.draw_x1()
